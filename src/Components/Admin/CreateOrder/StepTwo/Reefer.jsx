...
import { ReeferContainer, Cargo, CargoCategory } from "./data";
import PropTypes from 'prop-types';
import { IoIosArrowDown } from "react-icons/io";

const Reefer = ({ setFormData, formData, setAuth, setIsNext, auth }) => {
  ...
  const handleOptionClick = (key, option) => {
    ...
    if (key === "containerType") {
      newFormData.ncontainerType = Object.keys(ReeferContainer).find(
        (k) => ReeferContainer[k] === option
      );
